...
namespace Project58936
{
    public partial class Appointment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from [SLOTTABLE] where APP_DATE=@appdate1 and DOCTOR_NO=@docno", con);
            cmd.Parameters.Add("@appdate1", appdate1);
            cmd.Parameters.Add("@docno", docno);
            ...
            SqlCommand cmd1 = new SqlCommand("select * from [SLOTTABLE] where APP_DATE= @appdate2 and DOCTOR_NO=@docno", con);
            cmd1.Parameters.Add("@appdate2", appdate2);
            cmd1.Parameters.Add("@docno", docno);
            ...
            SqlCommand cmd2 = new SqlCommand("select * from [SLOTTABLE] where APP_DATE=@appdate3 and DOCTOR_NO=@docno", con);
            cmd2.Parameters.Add("@appdate3", appdate3);
            cmd2.Parameters.Add("@docno", docno);
            ...
            SqlCommand cmd3 = new SqlCommand("select * from [SLOTTABLE] where APP_DATE=@appdate4 and DOCTOR_NO=@docno", con);
            cmd3.Parameters.Add("@appdate4", appdate4);
            cmd3.Parameters.Add("@docno", docno);
...

        {
            ...
            else
            {
                ...
                String SLOT = data[0];
                string appdate1 = Calendar1.SelectedDate.ToShortDateString();
                SqlCommand cmd = new SqlCommand("update [SLOTTABLE] set " + SLOT + "='BOOKED' where APP_DATE=@appdate and DOCTOR_NO=@docno", con);
